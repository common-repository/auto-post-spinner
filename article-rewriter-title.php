...
/*Auto post spinner
 * This function name is auto_post_spinner_plugin_rewrite_content
 * And this is use for the rewrite of the title.
 * 
 */


function auto_post_spinner_plugin_rewrite_title($article){

        /*Auto post spinner
     * Here we initial the array of the synonyms of the words.
     * 
     */
...
" zookeeper " => " administrator ",
        ...
        /* Auto post spinner plugin
     * Word synonyms array end here
     * 
     */
	 ...
	 $words_artarray = explode(" ",$artarray);
             ...
             /* Auto post spinner
     * Here we explode the array of the article.
     * 
     */
...
/*  Auto post spinner
 *  Here we return the article by str_replace with special character
 */
